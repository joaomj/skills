...
## Alternative: Use Context7 Skill

If available in your agent skills, you can invoke:
```
Use skill: context7
Query: "How to configure Next.js middleware"
```

The skill will handle both steps automatically.
